...
official/supported Docker Images found at https://hub.docker.com/r/stealeum/stealeumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/stealeum/stealeumd-develop/ when changing the above text**