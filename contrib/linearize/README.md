# Linearize
Construct a linear, no-fork, best version of the Stealeum blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install stealeum_hash

https://github.com/stealeum/stealeum_hash
...
JSON-RPC server. Running `stealeumd` or `stealeum-qt -server` will be sufficient.
...
* `input`: stealeumd blocks/ directory containing blkNNNNN.dat
