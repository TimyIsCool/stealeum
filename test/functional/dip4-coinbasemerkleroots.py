...
from test_framework.test_framework import StealeumTestFramework
...
class LLMQCoinbaseCommitmentsTest(StealeumTestFramework):
    def set_test_params(self):
        self.set_stealeum_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as StealeumTestFramework doesn't support this atm)
