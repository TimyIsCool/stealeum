...
This mechanism has been integrated into Bitcore-Node-Stealeum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stealeum/insight-api-stealeum#web-socket-api](https://github.com/stealeum/insight-api-stealeum#web-socket-api)
* API: [https://github.com/stealeum/insight-api-stealeum#instantsend-transactions](https://github.com/stealeum/insight-api-stealeum#instantsend-transactions)
