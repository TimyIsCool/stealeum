...
Below are some notes on how to build Stealeum Core for Windows.
...
way. This will install to `c:\workspace\stealeum`, for example:

    make install DESTDIR=/mnt/c/workspace/stealeum
