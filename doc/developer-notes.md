...
Stealeum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Stealeum Core, where everyone uses
...
pay attention to for reviewers of Stealeum Core code.

General Stealeum Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Stealeum Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Stealeum Core so that they can be integrated
