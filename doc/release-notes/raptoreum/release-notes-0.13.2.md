Stealeum Core version 0.13.2.0
==========================
...
See detailed [set of changes](https://github.com/stealeum/stealeum/compare/v0.13.1.0...stealeum:v0.13.2.0).

### Backports

- [`548a48918`](https://github.com/stealeum/stealeum/commit/548a48918) Move IS block filtering into ConnectBlock (#2766)
- [`6374dce99`](https://github.com/stealeum/stealeum/commit/6374dce99) Fix error message for invalid voting addresses (#2747)
- [`25222b378`](https://github.com/stealeum/stealeum/commit/25222b378) Make -smartnodeblsprivkey mandatory when -smartnode is given (#2745)
- [`0364e033a`](https://github.com/stealeum/stealeum/commit/0364e033a) Implement 2-stage commit for CEvoDB to avoid inconsistencies after crashes (#2744)
- [`a11e2f9eb`](https://github.com/stealeum/stealeum/commit/a11e2f9eb) Add collateraladdress into smartnode/protx list rpc output (#2740)
- [`43612a272`](https://github.com/stealeum/stealeum/commit/43612a272) Only include selected TX types into CMerkleBlock (#2737)
- [`f868fbc78`](https://github.com/stealeum/stealeum/commit/f868fbc78) Stop g_connman first before deleting it (#2734)
- [`9e233f391`](https://github.com/stealeum/stealeum/commit/9e233f391) Fix incorrect usage of begin() when genesis block is requested in "protx diff" (#2699)
- [`e75f971b9`](https://github.com/stealeum/stealeum/commit/e75f971b9) Do not process blocks in CDeterministicMNManager before dip3 activation (#2698)
- [`1cc47ebcd`](https://github.com/stealeum/stealeum/commit/1cc47ebcd) Backport #14701: build: Add CLIENT_VERSION_BUILD to CFBundleGetInfoString (#2687)

### Other

- [`2516a6e19`](https://github.com/stealeum/stealeum/commit/2516a6e19) Bump version to 0.13.2
- [`9dd16cdbe`](https://github.com/stealeum/stealeum/commit/9dd16cdbe) Bump minChainWork and AssumeValid to block #1033120 (#2750)
- [`18f087b27`](https://github.com/stealeum/stealeum/commit/18f087b27) Fix some typos in doc/guide-startmany.md (#2711)
- [`709ab6d3e`](https://github.com/stealeum/stealeum/commit/709ab6d3e) Minimal fix for litemode vs bad-protx-key-not-same issue (#2694)
