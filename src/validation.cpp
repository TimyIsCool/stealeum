...
#if defined(NDEBUG)
# error "Stealeum Core cannot be compiled without assertions."
#endif
                                     ...
                                     const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool fDryRun)
{
    ...
    for (const CTxIn &txin : tx.vin)
    {
        ...
        if (itConflicting != pool.mapNextTx.end())
        {
            ...
            // Transaction conflicts with mempool and RBF doesn't exist in Stealeum
...
void ThreadScriptCheck() {
    RenameThread("stealeum-scriptch");
...
static int64_t nTimeStealeumSpecific = 0;
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    int64_t nTime5 = GetTimeMicros(); nTimeStealeumSpecific += nTime5 - nTime4;
    LogPrint(BCLog::BENCHMARK, "    - Stealeum specific: %.2fms [%.2fs]\n", 0.001 * (nTime5 - nTime4), nTimeStealeumSpecific * 0.000001);
