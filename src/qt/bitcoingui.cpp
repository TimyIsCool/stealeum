...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stealeum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stealeum: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Stealeum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stealeum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stealeum addresses"));
    ...
    openAction->setStatusTip(tr("Open a stealeum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Stealeum command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        // Add Stealeum logo on the right side
        QWidget* spacer = new QWidget();
        spacer->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        toolbar->addWidget(spacer);

        QLabel *logoLabel = new QLabel();
        QPixmap logoPixmap(":/images/stealeum_logo_toolbar");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stealeum network", "", count));
    } else {
...
{
    QString strTitle = tr("Stealeum Core"); // default title
