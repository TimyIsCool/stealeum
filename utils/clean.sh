...
rm -rf test_bitcoin.coverage/ stealeum-gtest.coverage/ total.coverage/
...
clean_exe src/stealeum-cli
clean_exe src/stealeumd
clean_exe src/stealeum-gtest
clean_exe src/stealeum-tx
